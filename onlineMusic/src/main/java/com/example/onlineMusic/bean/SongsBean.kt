...
class SongsBean {
    ...
    constructor()
    constructor(
        id: Long, name: String?, album: AlbumBean?, al: AlbumBean?, duration: Int, artists: List<ArtistsBean>?, musicUrl: String?, musicPath: String?, musicType: Int?, playerName: String?) {
        this.id = id
        this.name = name
        this.album = album
        this.al = al
